        ...
        <div class="mainframe">
            <div v-if="isError">
                <div class="error__block">
                    <div @click="this.isError = false" class="error__arrow header__arrow">
        ...
        async fetchData() {
            const options = {
                ...
                headers: {
                    ...
                    'X-RapidAPI-Key': '4d8fd502aamshd4d301a6aa6fbd5p164f09jsnc7b5e02ee9ae'
                }
            };
            ...
            try {
                ...
                fetch(
                    `https://community-open-weather-map.p.rapidapi.com/weather?q=${this.selectedCity}&%2Cuk&lat=0&lon=0&id=2172797&lang=null&units=imperial`,
                    options
                )
                    .then((response) => response.json())
                    .then((response) => { this.data = response; if (response.cod === "404") { throw new Error("error"); } })
